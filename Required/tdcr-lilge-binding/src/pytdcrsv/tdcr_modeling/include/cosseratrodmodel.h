...
public:
	...
	// This function returns the last final values of the shooting method for the last solution of the forward kinematics.
    ...
    Eigen::MatrixXd get_default_inits();
    void reset_last_inits();
    Eigen::MatrixXd getStatesSegment1();
    Eigen::MatrixXd getStatesSegment2();
